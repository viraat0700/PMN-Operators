...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ImageFluentd) DeepCopyInto(out *ImageFluentd) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ImageFluentd.
func (in *ImageFluentd) DeepCopy() *ImageFluentd {
	if in == nil {
		return nil
	}
	out := new(ImageFluentd)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PmnsystemSpec) DeepCopyInto(out *PmnsystemSpec) {
	*out = *in
	...
	out.Image = in.Image
	out.ImageFluentd = in.ImageFluentd
